...
public interface AccountAttributeMapper {
	...
	List<Account> getAccountByAttrValue(@Param(value = "tenantCode") String tenantCode,
			@Param(value = "segCode") String segCode, @Param(value = "attrCode") String attrCode,
			@Param(value = "value") String value);

	List<Account> getAccountByAttrValueOnSegment(@Param(value = "tenantCode") String tenantCode,
			@Param(value = "segCode") String segCode, @Param(value = "value") String value);
}