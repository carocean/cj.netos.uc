...
public interface ITenantAccountPort extends IOpenportService {
    ...
    @CjOpenport(usage = "分页租户下的账户", acl = {"allow administrators.role", "allow tests.role", "allow developer.role"})
    ...
    @CjOpenport(usage = "列出用户的所有账户", acl = {"allow administrators.role", "allow tests.role", "allow developer.role"})
