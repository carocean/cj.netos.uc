...
public interface IUcRolePort extends IOpenportService {
    @CjOpenport(usage = "添加角色", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "分页角色", elementType = UcRole.class, acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "分页角色的归属用户", elementType = UcUser.class, acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "列出一页用户的角色", elementType = UcRole.class, acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "添加角色到用户", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "移除角色从用户", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
