...
public interface ITenantRolePort extends IOpenportService {
    @CjOpenport(command = "post", usage = "添加租户角色", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "移除租户角色", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "获取租户角色", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "分页租户角色", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "列出用户的角色", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "分页租户角色下的用户", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "添加用户到租户角色", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "移除用户从租户角色", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
