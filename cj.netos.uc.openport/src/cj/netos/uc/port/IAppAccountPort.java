...
public interface IAppAccountPort extends IOpenportService {
    @CjOpenport(usage = "添加账户", command = "post", acl = {"allow administrators.role", "allow tests.role", "allow developers.role", "invisible *.*"})
    String addAccount(@CjOpenportParameter(name = "accountName", usage = "账号名") String accountName,
                      ...
                      @CjOpenportParameter(name = "accountPwd", usage = "账号密码") String accountPwd,
                      @CjOpenportParameter(name = "nickName", usage = "昵称") String nickName,
                      @CjOpenportParameter(name = "avatar", usage = "头像") String avatar,
                      @CjOpenportParameter(name = "signature", usage = "个人签名", in = InRequest.content) String signature) throws CircuitException;

    @CjOpenport(usage = "为指定用户添加登录账户", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "为指定用户添加手机账户", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "为指定用户添加邮箱账户", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "移除账户", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    void removeAccountById(@CjOpenportParameter(usage = "账户标识", name = "accountid") String accountid) throws CircuitException;

    @CjOpenport(usage = "分页租户下的账户", elementType = AppAccount.class, acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "列出用户的所有账户", elementType = AppAccount.class, acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    List<AppAccount> listAccount(@CjOpenportParameter(usage = "用户标识", name = "uid") String uid) throws CircuitException;

    @CjOpenport(usage = "获取账户", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    AppAccount getAccount(@CjOpenportParameter(usage = "账户标识", name = "accountid") String accountid) throws CircuitException;

    @CjOpenport(usage = "使活账户", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
