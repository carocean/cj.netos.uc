...
public interface ITenantPort extends IOpenportService {
    @CjOpenport(usage = "添加租户", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "移除租户", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    void removeTenant(@CjOpenportParameter(usage = "租户标识", name = "tenantid") String tenantid) throws CircuitException;

    @CjOpenport(usage = "分页租户", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "获取租户", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
