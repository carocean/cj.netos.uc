...
public interface IUcCompanyPort extends IOpenportService {
    @CjOpenport(usage = "添加公司", command = "post", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "移除公司", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    void removeCompany(@CjOpenportParameter(usage = "公司标识", name = "companyid") String companyid) throws CircuitException;

    @CjOpenport(usage = "分页公司", elementType = UcCompany.class, type = ArrayList.class, acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "分页子公司", elementType = UcCompany.class, type = ArrayList.class, acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "查询公司信息", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    UcCompany getCompany(@CjOpenportParameter(usage = "公司标识", name = "companyid") String companyid);

    @CjOpenport(usage = "公司是否存在", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
    ...
    @CjOpenport(usage = "清空父公司下的子公司", acl = {"allow administrators.role", "allow tests.role", "allow developers.role"})
